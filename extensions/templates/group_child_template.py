...
async def template_subcommand(ctx: lightbulb.SlashContext) -> None:
    ...
    botprint("WARNING! A Template child was called! "+__name__)

@template_subcommand.set_error_handler
